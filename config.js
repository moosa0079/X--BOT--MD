...
module.exports = {
	...
	ALIVE: process.env.ALIVE || "Hey Vro Im Alive💋",
	ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE || "false"),
	BGMBOT : toBool(process.env.BGMBOT || "true"),
	API: "https://api-aswin-sparky.koyeb.app",
	AUDIO_DATA: process.env.AUDIO_DATA || "Eva Mariya;Arjuu;https://files.catbox.moe/n5sz9g.png",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "Eva Mariya;Arjuu;https://files.catbox.moe/n5sz9g.png",
	...
	PING: process.env.PING || "Eva Mariya",
